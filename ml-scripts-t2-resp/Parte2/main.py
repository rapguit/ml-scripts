...
def main():
	...
	plt.cla()
	plt.plot(X[:,0], X[:,1], 'bo')
	save_img(plt, '../target/plot2_1.png')
	plt.show()
	...
	plt.axis('equal')
	save_img(plt, '../target/plot2_2.png')
	plt.show()
	...
	print(Z)
	plt.cla()
	plt.plot(Z, np.zeros(Z.shape), 'rx')
	save_img(plt, '../target/plot2_3.png')
	plt.show()
	...
	save_img(plt, '../target/plot2_4.png')
	plt.show()
	...
	plt.plot(X_rec[:,0], X_rec[:,1], 'rx')
	plt.axis('equal')
	save_img(plt, '../target/plot2_5.png')
	plt.show()


def save_img(plt, out_img):
